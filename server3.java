...
Expt. No. 05 Page No. 15 Expt. Name. Calculation of checksum for packet date and ?le. Date. 25/07/18 
			ServerSocket sSocket=new ServerSocket(1000);
			Socket cSocket=sSocket.accept();
			Bu?eredReader br=new Bu?eredReader(new   					InputStreamReader(cSocket.getInputStream()));
